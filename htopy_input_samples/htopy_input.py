...
################################################################################
# WARNING:  DO NOT CHANGE ANY VARIABLE NAMES ONLY EDIT THEIR CONTENTS.
"""
User input file sample.

Do not change/delete any variable names. Only edit their contents.
"""
